...
namespace CommunicateWithServer
{
    ...
    public class CommunicateWithServerDialogBotComponent : BotComponent
    {
        /// <summary>
        ...
        public override void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSingleton<DeclarativeType>(sp => new DeclarativeType<CommunicateWithServer>(CommunicateWithServer.Kind));
        }
    }
}
